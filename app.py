...
def gen_frames():
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            if len(eyes) == 2:
                cv2.putText(frame, "Liveness Detected", (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 255, 0), 2)
            else:
                cv2.putText(frame, "Spoof Detected", (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 0, 255), 2)
